...
| Date | Commit | Change | What could break |
|------|--------|--------|-----------------|
| 2026-07-30 | `7b96456` | Updated Week 5 peak long run from 18mi to 20mi. Aug 29 Saturday note updated: miles 1–16 @ 9:45/mi, miles 17–20 @ 9:07/mi if legs allow. Gel schedule updated (miles 5, 10, 14, 18). Weekly total updated to ~39mi. | Re-visiting /apply-plan.html re-applies the plan from CUTOFF (2026-07-27) onward; completed entries (Jul 27–present) reset to completed:false but Strava matchStravaToSchedule will re-sync them on next marathon.html open. |
